...
const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: "paid",
    description: "Launch campaign for new clothing line targeting Gen Z audience with viral-style content",
  ...
  return (
    ...
    >
      <div className="container-custom">
        ...
        {/* Filter Navigation */}
        <div
          className="flex gap-3 mb-10 scroll-x pb-2"
          role="tablist"
        ...
        >
          {filteredItems.map((item, index) => (
            <article
              key={item.id}
              className={`portfolio-card reveal group ${item.featured ? "md:col-span-2 lg:col-span-1" : ""}`}
              style={{ transitionDelay: `${index * 100}ms` }}
            >
              <div className="relative h-full bg-white dark:bg-[#1E2830] border border-[#E0E0E0] dark:border-[#2A3540] rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer">
                {/* Featured badge */}
                {item.featured && (
                ...
                >
                  <div className="text-6xl" aria-hidden="true">{item.icon}</div>
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-[#666666] dark:text-gray-400 mb-3">{item.type}</p>
